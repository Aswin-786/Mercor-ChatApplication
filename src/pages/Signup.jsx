    ...
    <div className='h-[100vh] w-full bg-screen flex flex-col items-center justify-center font-poppins'>
      ...
      <div className='md:w-[400px] w-[90%]  bg-gray-100  rounded-xl p-5'>
        ...
        <form
          ...
          <button className='outline-transparent mt-3 border-transparent w-1/2 py-2 text-white bg-cyan-500 rounded-md hover:opacity-70'>Sign Up</button>
          <p className='text-gray-600'>or</p>
          <button className='outline-transparent border-transparent my-1 w-[80%] py-2 text-white bg-red-600 rounded-md hover:bg-red-700' onClick={handleGoogle}> <i class="fa-brands fa-google "></i> Sign up with Google </button>
